...
public class KkboxWeeklyCollection extends BasicCollection {
	...
	public Map<String, List<MusicInfo>> getMusicInfo(WebDriver webDriver) throws MusicInfoException {
		...
		musicInfoMap.put(mandarinNewSheet, kkboxWeekly.getWeeklyWorkInfo(new Object[] {webDriver, mandarinNewUrl}));
		
		musicInfoMap.put(mandarinTrackSheet, kkboxWeekly.getWeeklyWorkInfo(new Object[] {webDriver, mandarinTrackUrl}));
		
		musicInfoMap.put(soundtrackTrackSheet, kkboxWeekly.getWeeklyWorkInfo(new Object[] {webDriver, soundtrackTrackUrl}));
		
		musicInfoMap.put(soundtrackAlbumSheet, kkboxWeekly.getWeeklyWorkInfo(new Object[] {webDriver, soundtrackAlbumUrl}));
		
		musicInfoMap.put(hiphopTrackSheet, kkboxWeekly.getWeeklyWorkInfo(new Object[] {webDriver, hiphopTrackUrl}));
		
		musicInfoMap.put(hiphopAlbumSheet, kkboxWeekly.getWeeklyWorkInfo(new Object[] {webDriver, hiphopAlbumUrl}));
