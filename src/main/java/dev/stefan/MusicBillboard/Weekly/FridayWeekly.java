...
public class FridayWeekly implements WeeklyWork {
	...
	private static final String PARA_MESSAGE = "取得Friday Music週榜參數出現錯誤";
	...
	public List<MusicInfo> getWeeklyWorkInfo(Object[] object) throws MusicInfoException {
		...
		try {
            ...
            //點選音樂類型 新歌、國語、西洋....
            webDriver.findElement(By.cssSelector("ul.idTabs.ui-tabs-nav.ui-helper-reset.ui-helper-clearfix.ui-widget-header.ui-corner-all"))
                    .findElements(By.tagName("li")).get(musicStyleEnum.ordinal())
                    .findElement(By.tagName("a")).click();
            Thread.sleep(5000);

            //點選單曲、專輯
            webDriver.findElement(By.id("ui-tabs-" + (musicStyleEnum.ordinal() + 1)))
                    .findElement(By.className("topchart_right_box"))
                    .findElement(By.className("topchart_rank_tab_usual"))
                    .findElements(By.tagName("li")).get(musicTypeEnum.ordinal())
                    .findElement(By.tagName("a")).click();
            Thread.sleep(5000);
            ...
            ((JavascriptExecutor) webDriver).executeScript("arguments[0].click()",
                    webDriver.findElement(By.id("ui-tabs-" + (musicStyleEnum.ordinal() + 1)))
                            .findElement(By.className("topchart_right_box"))
                            .findElement(By.className("topchart_box"))
                            .findElements(By.className("rankShow"))
                            .get(musicTypeEnum.ordinal())
