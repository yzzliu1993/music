...
public class SpotifyWeekly implements WeeklyWork {

	private static final String Para_Message = "Spotify週榜參數有誤";

	private static final String Execute_Message = "於Spotify週榜網頁發生錯誤";
