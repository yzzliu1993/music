...
public class KkboxDaily implements DailyWork {

	private static final String Para_Message = "KKbox日榜參數有誤";

	private static final String Execute_Message = "於KKbox日榜網頁發生錯誤";
